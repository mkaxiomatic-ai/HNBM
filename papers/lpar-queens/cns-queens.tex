...
all. Backtracking found a completion on every row.}\label{tab:results}
\end{table}
...
\tabref{tab:params} & \lstinline{SearchConfig}, \lstinline{benchModel} & \texttt{Search.lean}, \texttt{Bench.lean}\\
...
\texttt{HopfieldNet/QUBO/Instances/Queens/}; each link resolves to the file
itself.}\label{tab:map}
\end{table}
